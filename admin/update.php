...
?>
        ...
        <div class="row">
                ...
                <div class="block">
                    ...
                    <form name="form1" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                        <table>
                            ...
                            <tr>
                                <td>Room Name</td>
                                <td><input type="text" value="<?php echo "$rn" ?>" name="Room_name"></td>
                            </tr>
                            <tr>
                                <td>Room Price</td>
                                <td><input type="text" value="<?php echo "$rp" ?>" name="Room_price"></td>
                            </tr>
                            <tr>
                                <td>Room Services</td>
                                <td><input type="text" value="<?php echo "$rs" ?>" name="Room_services"></td>
                            </tr>
                            <tr>
                                <td>Room Description</td>
                                <td>
                                    <textarea cols="20" rows="5" name="Room_desc"><?php echo "$rd" ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>Add image</td>
            ...
            $sql1 = "UPDATE upload_hotel SET 
            Room_name='$Room_name',
            Room_price='$Room_price',
            Room_services='$Room_services',
            Room_desc='$Room_desc' WHERE Room_name='$Room_name'";
