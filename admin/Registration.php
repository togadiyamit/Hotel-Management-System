    ...
    <div class="container">
        <div class="main">
            ...
            <form action="" method="post" autocomplete="off">
                <div class="form-row">
                    <div class="col-lg-12">
                        <input type="text" name="admin_name" placeholder="Enter Your Name" class="form-control my-3 p-4"
                            required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="col-lg-12">
                        <input type="email" name="admin_email" placeholder="Enter Your Email Id"
                            class="form-control my-3 p-4" required>
                    </div>

                    <div class="col-lg-12">
                        <input type="tel" name="admin_contact" placeholder="Enter Your Contact Number"
                            class="form-control my-3 p-4" maxlength=10 required>
                    </div>
                </div>
                ...
                <div class="col-lg-13">
                    <input type="password" name="admin_password" placeholder="Enter Your Password"
                        class="form-control my-3 p-4" maxlength="8" required>
                </div>
        </div>
