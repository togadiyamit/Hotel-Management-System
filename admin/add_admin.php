...
?>
        ...
        <div class="row">
                ...
                <div class="block">
                    ...
                    <form name="form1" action="" method="post" enctype="multipart/form-data">
                        <table>
                            ...
                            <tr>
                                <td>Contact</td>
                                <td><input type="text" name="admin_contact"></td>
                            </tr>
                            <tr>
                                <td>Password</td>
                            ...
                            <tr class="table-borderless">
                                <td><input type="submit" name="sb" value="ADD ADMIN"></td>
          ...
          if (isset($_POST["sb"])) {
            ...
            $Sql1 = "INSERT INTO admin_registration VALUES (NULL,'$admin_name','$admin_email','$admin_contact','$admin_password');";
          ...
          ?>
            ...
            ?>
                            <tr>
                                ...
                                <td><?php echo $res['admin_password']; ?></td>
                                <td><a href="update_admin.php?an=<?php echo $res['admin_name']; ?>&
                      ae=<?php echo $res['admin_email']; ?>&
                      ac=<?php echo $res['admin_contact']; ?>&
                      ap=<?php echo $res['admin_password']; ?>">Update</a>
                                <td><a href="delete_admin.php?an=<?php echo $res['admin_name']; ?>&
                      ae=<?php echo $res['admin_email']; ?>&
                      ac=<?php echo $res['admin_contact']; ?>&
                      ap=<?php echo $res['admin_password']; ?>">Delete</a>
                            </tr>
